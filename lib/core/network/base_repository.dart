...
import 'package:sama_taxi/core/network/custom_network_handler.dart';
...
abstract class BaseRepository {
  ...
  /// Delete item by ID
  Future<NetworkResult<bool>> delete(String endpoint, String id) async => _networkHandler.delete<bool>(
      endpoint.replaceAll('{id}', id),
      parser: (data) => true,
    );
...
final baseRepositoryProvider = Provider<BaseRepository>((ref) => _BaseRepositoryImpl(ref.read(customNetworkHandlerProvider)));
