...
class EnhancedNetworkHandler extends CustomNetworkHandler {
  ...
  Future<List<NetworkResult<T>>> batchCachedRequests<T>(
    ...
    final futures = requests.map((request) => getCached<T>(
        request.endpoint,
